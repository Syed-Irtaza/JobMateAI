...
const ProfessionalSummaryForm = ({data, onChange, setResumeData}) => {
  ...
  const generateSummary = async ()=>{
    try{
      ...
      const promptt =`enhance my professional summary "${data}"`
      const response = await api.post('/api/ai/enhance-pro-sum',{userContent:promptt},{headers:{Authorization:token}})
