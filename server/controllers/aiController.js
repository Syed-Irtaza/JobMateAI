// controller for enchaning a resume's professional summary
...
// contoller for enhancing a resume's job description
...
export const uploadResume = async (req, res) => {
    try {
        ...
        {
        professsional_summary:{type:String,default:''},
        skills:[{type:String}],
        personal_info:{
